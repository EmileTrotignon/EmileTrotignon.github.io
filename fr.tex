...
Expérience extrêmement enrichissante dans une entreprise étrangère}
	...
	\section{Compétences techniques}
		...
		\subsection{Compilation}
			La compilation des langages de programmation est un sujet qui m'intéresse beaucoup. J'ai suivi lors de mon premier semestre de M1 un cours de compilation à l'Université de Paris, qui a pour but d'implémenter un language de programmation du style ML.
la description du cours est disponible ici : \url{https://www.irif.fr/~guatto//teaching/20-21/compil/syllabus-compil-20-21.pdf}.
Et mon code ici : \url{https://github.com/EmileTrotignon/cours-compilation-p7}.
